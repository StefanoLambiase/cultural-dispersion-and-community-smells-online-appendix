---
title: "Lone Wolf Model Construction"
output: lone_wolf_model_construction_html
---
...
# Reading input data.
data <- read.csv("./lone.csv", sep = ";", header = TRUE, stringsAsFactors=FALSE)
...
# Save in a txt file
sink("output_lone_all_variables.txt")
print(summary(lone))
Anova(lone)
sink()
...
# Save in a txt file
sink("output_lone_confounding_variables.txt")
print(summary(lone))
Anova(lone)
sink()
